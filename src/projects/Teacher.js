                ...
                <div className="flex flex-col mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 text-white h-fit max-xl:h-fit max-sm:px-7 max-md:grid-cols-1 gap-14">
                    <div className="flex flex-col gap-7">
                        <div className="text-center">
                            <span className='text-2xl font-bold uppercase tracking-widest'>Teacher Website</span>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-3">
                            ...
                            <a href="https://github.com/nazarenomarkanthony060120/Teacher_Website" target="_blank" rel="noopener noreferrer">
                                <span className='hover:text-blue-400 hover:underline'>https://github.com/nazarenomarkanthony060120/Teacher_Website</span>
                            </a>
                        </div>
                        <div className="flex flex-col gap-10">
                            ...
                            <div className="flex flex-col w-full gap-3">
                                ...
                                <img src={ViewPupils} alt="View Pupils" className=' h-96 w-full' />
                            </div>
                            <div className="flex flex-col w-full gap-3">
                                <span className='text-lg'>5. View Pupil Information</span>
                                <img src={ViewPupil} alt="View Pupil Information" className=' h-96 w-full' />
                            </div>
                            <div className="flex flex-col w-full gap-3">
                                <span className='text-lg'>6. Attendance</span>
                                <img src={Attendance} alt="Attendance" className=' h-96 w-full' />
                            </div>
                        </div>
                    </div>
                </div>
