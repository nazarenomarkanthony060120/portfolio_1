...
import DownloadCV from "../assets/Mark_Anthony_B_Nazareno_Resume.pdf";
...
export default function Home() {
  ...
  return (
    <>
      <div
        className="h-screen max-md:h-fit flex items-center justify-center"
        id="home"
      >
          ...
          <div className="flex justify-center text-start flex-col max-md:h-fit gap-6 max-sm:px-7 max-md:order-2">
            ...
            >
              <div className="flex flex-col max-md:text-center">
                <span className="text-[40px] max-lg:text-3xl] max-md:text-2xl max-sm:text-xl font-extrabold font-sans">
                  MARK ANTHONY NAZARENO
                </span>
                <div className="max-md:text-center">
                  <span className="text-[35px] max-lg:text-2xl max-md:text-xl max-sm:text-lg font-bold text-start">
                    And I'm a <span className="text-cyan-300">{text}</span>
                  </span>
                </div>
              </div>
            </Animate>
            ...
            >
              <span className="text-sm text-justify">
                Hello, I'm Mark, a Software Engineer with 2+ years of experience
                in developing dynamic and efficient websites. I specialize in
                native coding and have a strong command of Frontend technologies
                like React.js and Next.js, along with Backend technologies such
            ...
            >
              <div className="flex gap-5 h-7 max-md:justify-center">
                ...
                <a
                  href="https://github.com/nazarenomarkanthony060120"
                  className=" transition-transform transform hover:scale-150"
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            >
              <div className="max-md:text-center">
                <a href={DownloadCV} download>
                  <button className="rounded-lg bg-cyan-300 text-gray-800 shadow-lg hover:bg-cyan-500 hover:text-white hover:shadow-cyan-500 transition-transform transform hover:scale-110 font-bold w-fit px-3 py-2">
                    Download CV
                  </button>
                </a>
              </div>
            ...
            >
              <div className="relative">
                ...
                <div className="relative">
                  <img
                    src={Me}
                    className="rounded-full bg-gradient-to-t from-cyan-500 via-purple-500 to-pink-500 w-96 max-md:h-72 max-md:w-72 max-sm:h-56 max-sm:w-56 shadow-xl "
                    alt="My Image"
                  />
                </div>
              </div>
