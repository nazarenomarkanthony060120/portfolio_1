...
import NetReserved from "../images/NetReserved/NetReservedLogin.png";
import BCCOrdering from "../images/BCC_Canteen_Ordering_App/BCC_Canteen_Ordering_App.jpg";
import AttendanceSecurity from "../images/Attendance_Security/AttendanceSecurity.jpg";
                ...
                <div className="relative h-fit w-fit bg-white text-black rounded-xl transition-transform transform hover:scale-110">
                  ...
                  <div className="relative rounded-lg bg-white">
                    <div className="text-center flex flex-col gap-3">
                      <img
                        src={MinimartInventorySystem}
                        className="rounded-tl-lg rounded-tr-lg h-44"
                        alt="Minimart Inventory System"
                      />
                    ...
                    <div className="flex flex-col px-5 pt-5 pb-10 gap-5">
                      <div className="flex flex-col gap-2">
                        ...
                        <span>Backend: NodeJS, ExpressJs</span>
                        <span>Database: MySQL</span>
                      </div>
                      <div className="text-center flex flex-col gap-4">
                        <a
                          href="https://github.com/nazarenomarkanthony060120/Minimart_Inventory_System"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <button className="w-full py-2 rounded border-2 border-cyan-500 shadow-lg hover:shadow-cyan-500 hover:bg-cyan-500 hover:text-white">
                            Go To Github
                          </button>
                        </a>
                        <Link to="/minimart">
                          <button className="w-full py-2 rounded border-2 border-green-500 shadow-lg hover:shadow-green-500 hover:bg-green-500 hover:text-white">
                            View
                          </button>
                        </Link>
                      </div>
                  ...
                  <div className="relative rounded-lg bg-white">
                    ...
                    <div className="flex flex-col px-5 pt-5 pb-10 gap-5">
                      ...
                      <div className="flex flex-col text-center gap-4">
                        <a
                          href="https://github.com/nazarenomarkanthony060120/Admin_Website"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <button className="w-full py-2 rounded border-2 border-cyan-500 shadow-lg hover:shadow-cyan-500 hover:bg-cyan-500 hover:text-white">
                ...
                <div className="relative h-fit w-fit bg-white text-black rounded-xl transition-transform transform hover:scale-110">
                  ...
                  <div className="relative rounded-lg bg-white">
                    ...
                    <div className="flex flex-col px-5 pt-5 pb-10 gap-5">
                      ...
                      <div className="flex flex-col text-center gap-4">
                        <a
                          href="https://github.com/nazarenomarkanthony060120/Parent_Website"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <button className="w-full py-2 rounded border-2 border-cyan-500 shadow-lg hover:shadow-cyan-500 hover:bg-cyan-500 hover:text-white">
                ...
                <div className="relative h-fit w-fit bg-white text-black rounded-xl transition-transform transform hover:scale-110">
                  ...
                  <div className="relative rounded-lg bg-white">
                    ...
                    <div className="flex flex-col px-5 pt-5 pb-10 gap-5">
                      ...
                      <div className="flex flex-col text-center gap-4">
                        <a
                          href="https://github.com/nazarenomarkanthony060120/Attendance_Application"
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <button className="w-full py-2 rounded border-2 border-cyan-500 shadow-lg hover:shadow-cyan-500 hover:bg-cyan-500 hover:text-white">
              ...
              >
                <div className="relative h-fit w-fit bg-white text-black rounded-xl transition-transform transform hover:scale-110">
                  ...
                  <div className="relative rounded-lg bg-white">
                    ...
                    <div className="flex flex-col px-5 pt-5 pb-10 gap-5">
                      <div className="flex flex-col gap-2">
                        <span>Frontend: React Native Expo, Tanstack Query</span>
                        <span>Backend: N/A</span>
                        <span>Database: Firebase Firestore</span>
                      </div>
                      <div className="flex flex-col text-center gap-4">
