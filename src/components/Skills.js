...
import TanstackReactQuery from "../images/TanstackReactQuery.png";
import MaterialUI from "../images/MaterialUI.png";
import Nativewind from "../images/Nativewind.png";
...
function Skills() {
  ...
  const [isPassionFroProblemSolving, setIsPassionFroProblemSolving] =
    useState(false);
        ...
        <div className="flex flex-col mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 text-white h-fit max-xl:h-fit max-sm:px-7 max-md:grid-cols-1 gap-14">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-5 ">
              ...
              <div className="flex justify-center max-xl:justify-center max-sm:justify-center text-center max-sm:gap5 flex-wrap  gap-3">
            ...
            <div className="flex items-center flex-col gap-5">
              <span className="text-lg">Styling</span>
              <div className="flex max-sm:justify-center max-sm:gap5 flex-wrap  gap-8">
                ...
                <div className="relative rounded-lg border-2 border-cyan-300 w-44 ">
                  <div className="absolute w-full h-full blur-lg bg-gradient-to-t from-green-500 via-yellow-500 to-red-500"></div>
                  <div className="relative flex flex-col gap-2 p-3 w-full h-full items-center bg-black rounded-lg ">
                    <span className="text-lg text-center">Material UI</span>
                ...
                <div className="relative rounded-lg border-2 border-cyan-300 w-44 ">
                  <div className="absolute w-full h-full blur-lg bg-gradient-to-t from-green-500 via-yellow-500 to-red-500"></div>
                  <div className="relative flex flex-col gap-2 p-3 w-full h-full items-center bg-black rounded-lg ">
                    <span className="text-lg text-center">Nativewind</span>
                    <img src={Nativewind} alt="Nativewind" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center flex-col gap-5">
              ...
              <div className="flex max-sm:justify-center max-sm:gap5 flex-wrap  gap-8">
                <div className="relative rounded-lg border-2 border-cyan-300 w-44 h-fit">
                  <div className="absolute w-full h-full blur-lg bg-gradient-to-t from-green-500 via-yellow-500 to-red-500"></div>
                  <div className="relative flex flex-col gap-2 p-3 w-full h-full items-center bg-black rounded-lg ">
                    <span className="text-lg">GraphQL</span>
                ...
                <div className="relative rounded-lg border-2 border-cyan-300 w-44 ">
                  ...
                  <div className="relative flex flex-col gap-2 p-3 w-full h-full items-center bg-black rounded-lg ">
                    ...
                    <div className="h-full flex items-center justify-center">
                      <img src={TanstackReactQuery} alt="React JS" />
                    </div>
                  </div>
                </div>
                <div className="relative rounded-lg border-2 border-cyan-300 w-44 ">
                  <div className="absolute w-full h-full blur-lg bg-gradient-to-t from-green-500 via-yellow-500 to-red-500"></div>
                  <div className="relative flex flex-col gap-2 p-3 w-full h-full items-center bg-black rounded-lg ">
                    <span className="text-lg text-center">Axios</span>
                    <div className="h-full flex items-center justify-center">
                      <img src={Axios} alt="React JS" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="flex items-center justify-between max-xl:justify-evenly max-lg:justify-center flex-wrap gap-3">
              <div className="flex items-center text-center flex-col flex-wrap gap-2">
                <div className="w-24">
                  <VisibilitySensor
                    onChange={() => setIsGoodCommunication(true)}
                  >
                    <CircularProgressbar
                      value={isGoodCommunication ? 90 : 0}
                      styles={buildStyles({
                        textColor: "white",
                        pathTransitionDuration: 1,
                        pathColor: "rgb(103, 232, 249)",
                        trailColor: "gray",
                      })}
                      text={`90%`}
                      animateOnRender
              ...
              <div className="flex items-center text-center flex-col flex-wrap gap-2">
                <div className="w-24">
                  <VisibilitySensor
                    onChange={() => setIsPassionFroProblemSolving(true)}
                  >
                    <CircularProgressbar
                      value={isPassionFroProblemSolving ? 100 : 0}
                      styles={buildStyles({
                        textColor: "white",
                        pathTransitionDuration: 1,
                        pathColor: "rgb(103, 232, 249)",
              ...
              <div className="flex items-center text-center flex-col flex-wrap gap-2">
                <div className="w-24">
                  <VisibilitySensor
                    onChange={() => setIsBasicMathematical(true)}
                  >
                    <CircularProgressbar
                      value={isBasicMathematical ? 100 : 0}
                      styles={buildStyles({
                        textColor: "white",
                        pathTransitionDuration: 1,
                        pathColor: "rgb(103, 232, 249)",
              ...
              <div className="flex items-center text-center flex-col flex-wrap gap-2">
                <div className="w-24">
                  <VisibilitySensor
                    onChange={() => setIsEasyToAdaptNewTech(true)}
                  >
                    <CircularProgressbar
                      value={isEasyToAdaptNewTech ? 90 : 0}
                      styles={buildStyles({
                        textColor: "white",
                        pathTransitionDuration: 1,
                        pathColor: "rgb(103, 232, 249)",
